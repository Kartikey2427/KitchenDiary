...
exports.homepage = async(req,res) => {
    ...
    try {
        ...
        res.render('index', { title: 'The Kitchen Diary', categories, food });
    } catch (error) {
...
exports.exploreCategories = async (req, res) => {
    ...
    try {
        ...
        const categories = await Category.find({}).limit(limitNumber);
        res.render('categories', { title: 'The Kitchen Diary', categories });
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreCategoriesByID = async (req, res) => {
    ...
    try {
        ...
        res.render('categories', { title: 'The Kitchen Diary - Categories', categoryById });
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreRecipe = async (req, res) => {
    ...
    try {
        ...
        res.render('recipe', { title: 'The Kitchen Diary - Recipe', recipe } );
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.searchRecipe = async (req, res) => {
    ...
    try {
        ...
        res.render('search', { title: 'The Kitchen Diary - Search', recipe });
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreLatest = async (req, res) => {
    ...
    try {
        ...
        res.render('explore-latest', { title: 'The Kitchen Diary - Explore Latest', recipe });
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreRandom = async (req, res) => {
    ...
    try {
        ...
        res.render('explore-random', { title: 'The Kitchen Diary - Explore Latest', recipe });
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.submitRecipe = async (req, res) => {
    ...
    res.render('submit-recipe', { title: 'The Kitchen Diary - Submit Recipe', infoErrorsObj, infoSubmitObj });
}
